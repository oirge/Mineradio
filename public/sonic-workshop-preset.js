/**
 * 音域回响 (Wallpaper Engine 原作) — 视觉预设 8 的壁纸层。
 *
 * 这一层不是重写, 而是把 CmzYa 的 Wallpaper Engine 作品「音域回响」(workshopid 3747222633)
 * 的打包产物原样嵌进来: public/vendor/sonic-workshop/ 下是作者的 WE 工程构建结果,
 * mineradio-bridge.html 用一层 shim 顶替 Wallpaper Engine 的宿主 API
 * (wallpaperRegisterAudioListener / wallpaperPropertyListener / 媒体监听),
 * 本文件负责把 Mineradio 的音频、封面、播放状态按 WE 的格式喂进去。
 *
 * 桥接代码与 vendor 目录搬自上游 XxHuberrr/Mineradio 的 public/sonic-workshop-preset.js
