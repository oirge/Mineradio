...
contextBridge.exposeInMainWorld('desktopOverlay', {
  ...
  setLyricsStableState: (stable) => ipcRenderer.invoke('mineradio-desktop-lyrics-set-stable-state', !!stable),
  setLyricsTranslation: (on) => ipcRenderer.invoke('mineradio-desktop-lyrics-set-translation', !!on),
